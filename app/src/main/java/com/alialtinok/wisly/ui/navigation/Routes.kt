...
object Routes {
    ...
    const val PHRASAL_FLASHCARDS = "study/phrasal-flash"
    const val IDIOM_FLASHCARDS = "study/idiom-flash"
    const val QUIZ = "practice/quiz"
    const val WRITING = "practice/writing"
